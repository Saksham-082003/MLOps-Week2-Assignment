...
import subprocess
import sys
# subprocess.run([sys.executable, "-m", "pip", "install", "--upgrade", "--quiet", "google-cloud-aiplatform"])

# ### Set Google Cloud project information 
# Learn more about [setting up a project and a development environment](https://cloud.google.com/vertex-ai/docs/start/cloud-environment).

# PROJECT_ID = "vast-advantage-461609-t2"  # @param {type:"string"}
...
# BUCKET_URI = f"gs://mlops-course-vast-advantage-461609-t2-unique"  # @param {type:"string"}

# **If your bucket doesn't already exist**: Run the following cell to create your Cloud Storage bucket.

# subprocess.run(["gsutil", "mb", "-l", LOCATION, "-p", PROJECT_ID, BUCKET_URI])
...
# subprocess.run(["gsutil", "cp", "artifacts/model.joblib", f"{BUCKET_URI}/{MODEL_ARTIFACT_DIR}/"])